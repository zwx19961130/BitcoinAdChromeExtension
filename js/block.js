...
//$(function() {
   ...
   /* $(document).ready(function() {
            ...
            document.getElementById("blockButton").click(function () {
                clearAd.init();
   ...
   /* });*/
    ...
    $(document).ready(function () {
        $.getJSON("http://wx.weimtek.cn/user/me", function (json) {

            var html = "";
            html += "<img src=" + json["avatarUrl"] + ">";
            $("#avatarUrl").html(html);

            var html = "";
            html += "<div id='nickName'> "+ json["nickName"] + "</div>";
            $("#nickName").html(html);

            var html = "";
            html += "<div id='balance'>" + json["balance"] + "</div>";
            $("#balance").html(html);


            var html = "";
            html += "<div id='gender'>" + (json["gender"] == "1" ? "男" : "女")  + "</div>";
            $("#gender").html(html);


            var html = "";
            html += "<div id='province'>" + json["province"] + "</div>";
            $("#province").html(html);

            //$("#nickName").html(JSON.stringify(json["nickName"]));
